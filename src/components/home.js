...
import photo1 from "../components/static/treespl.jpg";
import photo2 from "../components/static/sports.png";
import photo3 from "../components/static/independence.jpeg";
  ...
  const handle = async (e) => {
    ...
    const response = await fetch(
      `http://${state.backend}:${state.port}/api/b/bookroom`,
      {
        ...
        body: JSON.stringify({ room: Number(sroom) }),
      }
    );
                ...
                <div className="flex flex-wrap -mx-3 twrem">
                  <div className="max-w-full px-3 lg:w-1/2 lg:flex-none">
                    <div className="flex flex-col h-full">
                      ...
                      <h5 className="font-bold">SFIT Hostel</h5>
                      <p className="mb-12">
                      ...
                      <a
                        ...
                        target={"_blank"}
                        href="https://collegedunia.com/college/15309-st-francis-institute-of-technology-sfit-mumbai/hostel"
                      >
                        Read More
                        <i
                ...
                <div className="relative z-10 flex flex-col flex-auto h-full p-4">
                  ...
                  <div>
                    <div className="d-flex rdetails">
                      ...
                      <p className="stdd">
                        Hostel : <span className="hstdd">SFIT</span>
                      </p>
                    </div>
                    <div className="d-flex rdetails">
                      <p className="stdd">
